...
namespace FastColoredTextBoxNS
{
    ...
    brackets.Attributes["left2"].Value == "" || brackets.Attributes["right2"].Value == "")
        ...
        public virtual void VBSyntaxHighlight(Range range)
        {
            ...
            range.SetFoldingMarkers(@"^\s*(?<range>While)[ \t]+\S+", @"^\s*(?<range>End\s+While)\b", RegexOptions.Multiline | RegexOptions.IgnoreCase);
            range.SetFoldingMarkers(@"\b(Sub|Function)[ \t]+[^\s']+", @"\bEnd\s+(Sub|Function)\b", RegexOptions.IgnoreCase);//this declared separately because Sub and Function can be unclosed
            range.SetFoldingMarkers(@"(\r|\n|^)[ \t]*(?<range>Get|Set)[ \t]*(\r|\n|$)", @"\bEnd\s+(Get|Set)\b", RegexOptions.IgnoreCase);
        ...
        void InitQTPRegex()
        {
            QTPStringRegex = new Regex(@"""""|"".*?[^\\]""", RegexCompiledOption);
            QTPCommentRegex = new Regex(@"'.*$", RegexOptions.Multiline | RegexCompiledOption);
            QTPNumberRegex = new Regex(@"\b\d+[\.]?\d*([eE]\-?\d+)?\b", RegexCompiledOption);
            QTPClassNameRegex = new Regex(@"\b(Class|Structure|Enum|Interface)[ ]+(?<range>\w+?)\b", RegexOptions.IgnoreCase | RegexCompiledOption);
            QTPKeywordRegex = new Regex(@"\b(AddHandler|AddressOf|Alias|And|AndAlso|As|Boolean|ByRef|Byte|ByVal|Call|Case|Catch|CBool|CByte|CChar|CDate|CDbl|CDec|Char|CInt|Class|CLng|CObj|Const|Continue|CSByte|CShort|CSng|CStr|CType|CUInt|CULng|CUShort|Date|Decimal|Declare|Default|Delegate|Dim|DirectCast|Do|Double|Each|Else|ElseIf|End|EndIf|Enum|Erase|Error|Event|Exit|False|Finally|For|Friend|Function|Get|GetType|GetXMLNamespace|Global|GoSub|GoTo|Handles|If|Implements|Imports|In|Inherits|Integer|Interface|Is|IsNot|Let|Lib|Like|Long|Loop|Me|Mod|Module|MustInherit|MustOverride|MyBase|MyClass|Namespace|Narrowing|New|Next|Not|Nothing|NotInheritable|NotOverridable|Object|Of|On|Operator|Option|Optional|Or|OrElse|Overloads|Overridable|Overrides|ParamArray|Partial|Private|Property|Protected|Public|RaiseEvent|ReadOnly|ReDim|REM|RemoveHandler|Resume|Return|SByte|Select|Set|Shadows|Shared|Short|Single|Static|Step|Stop|String|Structure|Sub|SyncLock|Then|Throw|To|True|Try|TryCast|TypeOf|UInteger|ULong|UShort|Using|Variant|Wend|When|While|Widening|With|WithEvents|WriteOnly|Xor|Region)\b|(#Const|#Else|#ElseIf|#End|#If|#Region)\b", RegexOptions.IgnoreCase | RegexCompiledOption);
            QTPTOKeywordRegex = new Regex(@"\b(SlvAccordion|SlvButton|SlvCalendar|SlvCheckBox|SlvComboBox|SlvDataPager|SlvDialog|SlvEdit|SlvExpander|SlvLink|SlvList|SlvMenu|SlvObject|SlvPage|SlvProgressBar|SlvRadioButton|SlvScrollBar|SlvSlider|SlvTable|SlvTabStrip|SlvToggleButton|SlvTreeView|SlvWindow|WbfCalendar|WbfGrid|WbfTabStrip|WbfToolbar|WbfTreeView|WbfUltraGrid|SwfButton|SwfCalendar|SwfCheckBox|SwfComboBox|SwfEdit|SwfEditor|SwfLabel|SwfList|SwfListView|SwfObject|SwfPropertyGrid|SwfRadioButton|SwfScrollBar|SwfSpin|SwfStatusBar|SwfTab|SwfTable|SwfToolBar|SwfTreeView|SwfWindow|WpfButton|WpfCalendar|WpfCheckBox|WpfComboBox|WpfEdit|WpfImage|WpfLink|WpfList|WpfMenu|WpfObject|WpfProgressBar|WpfRadioButton|WpfScrollBar|WpfSlider|WpfStatusBar|WpfTable|WpfTabStrip|WpfToolbar|WpfTreeView|WpfWindow|AcxButton|AcxCalendar|AcxCheckBox|AcxComboBox|AcxEdit|AcxRadioButton|AcxTable|DelphiButton|DelphiCheckBox|DelphiComboBox|DelphiEdit|DelphiEditor|DelphiList|DelphiListView|DelphiNavigator|DelphiObject|DelphiRadioButton|DelphiScrollBar|DelphiSpin|DelphiStatic|DelphiStatusBar|DelphiTable|DelphiTabStrip|DelphiTreeView|DelphiWindow|FlexButton|FlexCalendar|FlexCheckBox|FlexComboBox|FlexDialog|FlexDropDownButton|FlexEdit|FlexList|FlexMenu|FlexObject|FlexProgressBar|FlexRadioButton|FlexSlider|FlexSpin|FlexStaticText|FlexTable|FlexTabStrip|FlexToggleButton|FlexTreeView|FlexWindow|InsightObject|JavaApplet|JavaButton|JavaCalendar|JavaCheckBox|JavaDialog|JavaEdit|JavaExpandBar|JavaInternalFrame|JavaLink|JavaList|JavaMenu|JavaObject|JavaRadioButton|JavaSlider|JavaSpin|JavaStaticText|JavaTab|JavaTable|JavaToolbar|JavaTree|JavaWindow|OracleApplications|OracleButton|OracleCalendar|OracleCheckbox|OracleFlexWindow|OracleFormWindow|OracleList|OracleListOfValues|OracleLogon|OracleNavigator|OracleNotification|OracleRadioGroup|OracleStatusLine|OracleTabbedRegion|OracleTable|OracleTextField|OracleTree|PSFrame|PbButton|PbCheckBox|PbComboBox|PbDataWindow|PbEdit|PbList|PbListView|PbObject|PbRadioButton|PbScrollBar|PbTabStrip|PbToolbar|PbTreeView|PbWindow|SAPButton|SAPCalendar|SAPCheckBox|SAPDropDownMenu|SAPEdit|SAPFrame|SAPiView|SAPList|SAPMenu|SAPNavigationBar|SAPOKCode|SAPPortal|SAPRadioGroup|SAPStatusBar|SAPTable|SAPTabStrip|SAPTreeView|SAPGuiAPOGrid|SAPGuiButton|SAPGuiCalendar|SAPGuiCheckBox|SAPGuiComboBox|SAPGuiEdit|SAPGuiElement|SAPGuiGrid|SAPGuiLabel|SAPGuiMenubar|SAPGuiOKCode|SAPGuiRadioButton|SAPGuiSession|SAPGuiStatusBar|SAPGuiTable|SAPGuiTabStrip|SAPGuiTextArea|SAPGuiToolbar|SAPGuiTree|SAPGuiUtil|SAPGuiWindow|SiebApplet|SiebApplication|SiebButton|SiebCalculator|SiebCalendar|SiebCheckbox|SiebCommunicationsToolbar|SiebCurrency|SiebInkData|SiebList|SiebMenu|SiebPageTabs|SiebPDQ|SiebPicklist|SiebRichText|SiebScreen|SiebScreenViews|SiebTask|SiebTaskAssistant|SiebTaskLink|SiebTaskStep|SiebTaskUIPane|SiebText|SiebTextArea|SiebThreadbar|SiebToolbar|SiebTree|SiebView|SiebViewApplets|Desktop|Dialog|Static|SystemUtil|WinButton|WinCalendar|WinCheckBox|WinComboBox|Window|WinEdit|WinEditor|WinList|WinListView|WinMenu|WinObject|WinRadioButton|WinScrollBar|WinSpin|WinStatusBar|WinTab|WinToolbar|WinTreeView|WinTab|WinTable|WinToolbar|WinTreeView|TeField|TeScreen|TeTextScreen|TeWindow|VbButton|VbCheckBox|VbComboBox|VbEdit|VbEditor|VbFrame|VbLabel|VbList|VbListView|VbRadioButton|VbScrollBar|VbToolbar|VbTreeView|VbWindow|Browser|Frame|Image|Link|Page|ViewLink|WebArea|WebButton|WebCheckBox|WebEdit|WebElement|WebFile|WebList|WebRadioGroup|WebTable|WebXML|ASPAjaxAccordion|ASPAjaxAlwaysVisibleControl|ASPAjaxAutoComplete|ASPAjaxCalendar|ASPAjaxCollapsiblePanel|ASPAjaxComboBox|ASPAjaxConfirmButton|ASPAjaxDragPanel|ASPAjaxDropDown|ASPAjaxHoverMenu|ASPAjaxListSearch|ASPAjaxMultiHandleSlider|ASPAjaxNumericUpDown|ASPAjaxPagingIndex|ASPAjaxRating|ASPAjaxReorderList|ASPAjaxResizableControl|ASPAjaxRichTextArea|ASPAjaxSlider|ASPAjaxTabs|ASPAjaxToggleButton|DojoAccordion|DojoCalendar|DojoCollapsiblePanel|DojoComboButton|DojoDropDownButton|DojoDropDownMenu|DojoFilterComboBox|DojoProgressBar|DojoRichTextArea|DojoSlider|DojoTabStrip|DojoToggleButton|DojoToolbar|DojoTree|GWTAccordion|GWTCollapsiblePanel|GWTDialogBox|GWTMenuBar|GWTPushButton|GWTRichTextArea|GWTTabStrip|GWTToggleButton|GWTTree|jQUIAccordion|jQUICalendar|jQUIList|jQUISlider|jQUITabStrip|jQUIToggleButton|YUICalendar|YUIComboButton|YUIDialogBox|YUIDropDownButton|YUILinkButton|YUIMenu|YUIRadioGroup|YUIRichTextArea|YUISlider|YUITable|YUITabStrip|YUIToggleButton|YUITree|Crypt|DataTable |Description|DotNetFactory|DTParameter|DTSheet|Environment|Extern|LocalParameter|MercuryTimers (Collection)|MercuryTimer|Parameter|PathFinder|Properties (Collection)|QCUtil|RandomNumber|Recovery|Reporter|RepositoriesCollection|Repository|Services|Setting|SystemMonitor|TextUtil|VisualRelation|VisualRelations|VisualRelationsCollection|XMLUtil|DbTable|VirtualButton|VirtualCheckBox|VirtualList|VirtualObject|VirtualRadioButton|VirtualTable|)\b", RegexOptions.IgnoreCase | RegexCompiledOption);
        }
        ...
        /// </summary>
        /// <param name="range"></param>
        public virtual void QTPSyntaxHighlight(Range range)
        {
            range.tb.CommentPrefix = "'";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
            ...
            range.tb.RightBracket2 = '\x0';
            //clear style of changed range
            range.ClearStyle(StringStyle, CommentStyle, NumberStyle, ClassNameStyle, KeywordStyle,KeywordStyle2);
            //
            if (QTPStringRegex == null)
                InitQTPRegex();
            //string highlighting
            range.SetStyle(StringStyle, QTPStringRegex);
            //comment highlighting
            range.SetStyle(CommentStyle, QTPCommentRegex);
            //number highlighting
            range.SetStyle(NumberStyle, QTPNumberRegex);
            //class name highlighting
            range.SetStyle(ClassNameStyle, QTPClassNameRegex);
            //keyword highlighting
            range.SetStyle(KeywordStyle, QTPKeywordRegex);
            range.SetStyle(KeywordStyle2, QTPTOKeywordRegex);
    ...
    {
        Custom, CSharp, VB, HTML, SQL, PHP, JS, QTP
    }
}
